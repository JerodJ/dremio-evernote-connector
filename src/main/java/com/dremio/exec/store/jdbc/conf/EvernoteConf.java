...
@SourceType(value = "EvernoteARP", label = "Evernote",uiConfig = "evernote-layout.json")
public class EvernoteConf extends AbstractArpConf<EvernoteConf> {
  private static final String ARP_FILENAME = "arp/implementation/evernote-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.evernote.EvernoteDriver";
